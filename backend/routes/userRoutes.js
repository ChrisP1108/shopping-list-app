...
const { putUserUpdate, putUserUpdateSettings, putUserRecoveryComplete } = require('../controllers/userController/put');
...
router.put('/:id/settings', protect, putUserUpdateSettings); // Update User Credentials
